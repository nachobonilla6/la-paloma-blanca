...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('property_contents', function (Blueprint $table) {
            ...
            $table->string('articles_title')->default('Happiest Country');
            $table->text('articles_intro')->nullable();
            $table->string('contact_title')->default('Interested?');
            ...
            $table->string('contact_whatsapp')->default('+184...0404');
    ...
    public function down(): void { Schema::dropIfExists('property_contents'); }
};
